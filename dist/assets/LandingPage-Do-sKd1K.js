function l(){const e=document.getElementById("main-content");e&&(e.innerHTML=`
    <!-- Hero Section -->
  ...
  `,s())}function s(){document.getElementById("get-started-btn")?.addEventListener("click",()=>{window.location.href="/register"}),document.getElementById("learn-more-btn")?.addEventListener("click",()=>{const e=document.querySelectorAll("h2");let t=null;for(const a of e)if(a.textContent?.includes("Everything you need for mindful journaling")){t=a.parentElement;break}t||(t=document.querySelector(".py-12.bg-white")),t&&t.scrollIntoView({behavior:"smooth"})}),document.getElementById("cta-signup-btn")?.addEventListener("click",()=>{window.location.href="/register"})}export{l as renderLandingPage};
//# sourceMappingURL=LandingPage-Do-sKd1K.js.map
